...
state = '55' # 55 is WI's state FIPS code
counties = []

for i in range(1,143,2): # WI's counties range from 001 to 141 skipping even numbers
    x = str(i).zfill(3)
    counties.append(x)
...
#save file  
data.to_csv('/Users/hwheelen/Documents/GitHub/PGP_RapidResponse/Wisconsin/data/WI2010pop_breakdown.csv')
